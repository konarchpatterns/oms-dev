...
@section('content')
    <div class="container">
        ...
        <div class="row">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Vector</td>
                                        <td>
                                            @foreach ($curr_mnth_vector as $val)
                                    ...
                                    <tr>
                                        <td>Digitize</td>
                                        <td>
                                            @foreach ($curr_mnth_digit as $val)
                                    ...
                                    <tr>
                                        <td>Vector</td>
                                        <td>
                                            @foreach ($prv_mnth_vector as $val)
                                                <span>{{ $val->totvect }}</span>
                                            @endforeach
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Digitize</td>
                                        <td>
                                            @foreach ($prv_mnth_digit as $val1)
            ...
            @if (Auth::user()->email == 'anis@patterns.com' || Auth::user()->email == 'jubbin@patterns.com' || Auth::user()->email == 'shraddha@patterns.com' || Auth::user()->email == 'kalyan@patterns.com' || Auth::user()->email == 'kulind@patterns.com' || Auth::user()->email == 'tallin@patterns.com' || Auth::user()->email == 'babul@patterns.com' || Auth::user()->email == 'pfalnikarp@patterns.com')
                <div class="col-sm-4 col-lg-4">
                    <div class="dash-unit">
                    ...
                    <table class="table table-bordered table-condensed chgtable">
                        ...
                        <tbody>
                            <tr>
                                <td>Vector</td>
                                <td>
                                    <div class="dvect_td"> </div>
                                </td>
                                @permission('file.price.dashboard')
                                    <td>
                                        <div class="dvectprice_td"></div>
                                    </td>
                                @endpermission
                            </tr>
                            <tr>
                                <td>Digitize</td>
                                <td>
                                    <div class="ddigi_td"> </div>
                                </td>

                                @permission('file.price.dashboard')
                                    <td>
                                        <div class="ddigiprice_td"> </div>
                                    </td>
                                @endpermission
                            </tr>
                            <tr>
                                <td>Image Editing</td>
                                <td>
                                    <div class="dphoto_td"> </div>
                                </td>
                                @permission('file.price.dashboard')
                                    <td>
                                        <div class="dphotoprice_td"> </div>
                                    </td>
                                @endpermission
                            </tr>
                            ...
                            <tr>
                                <td>Approved:</td>
                                <td>
                                    <div class="dapprov_td"></div>
                                </td>
                                @permission('file.price.dashboard')
                                    <td>
                                        <div class="dapprovprice_td"></div>
                                    </td>
                                @endpermission
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>QC-Pending:</td>
                                <td>
                                    <div class="dqcpend_td"></div>
                                </td>
                                @permission('file.price.dashboard')
                                    <td>
                                        <div class="dqcpendprice_td"></div>
                                    </td>
                                @endpermission
                            ...
                            <tr>
                                <td>QC Ok:</td>
                                <td>
                                    <div class="dqcok_td"></div>
                                </td>
                                @permission('file.price.dashboard')
                                    <td>
                                        <div class="dqcokprice_td"></div>
                                    </td>
                                @endpermission
                            </tr>
                            <tr>
                                <td>Vect.Compl.:</td>
                                <td>
                                    <div class="dcompvect_td"></div>
                                </td>
                                @permission('file.price.dashboard')
                                    <td>
                                        <div class="dcompvectprice_td"></div>
                                    </td>
                                @endpermission
                            </tr>
                            <tr>
                                <td>Digit.Compl.:</td>
                                <td>
                                    <div class="dcompdigit_td"></div>
                                </td>
                                @permission('file.price.dashboard')
                                    <td>
                                        <div class="dcompdigitprice_td"></div>
                                    </td>
                                @endpermission
                            </tr>
                            ...
                            <tr>
                                <td>Tot. Completed:</td>
                                <td>
                                    <div class="dcompl_td"></div>
                                </td>
                                @permission('file.price.dashboard')
                                    <td>
                                        <div class="dcomplprice_td"></div>
                                    </td>
                                @endpermission
                            </tr>
            ...
            <div class="col-sm-4 col-lg-4">
                ...
                <div class="dash-unit">
                    <dtitle class="boldtext">Daily Status (US Yesterday) <span class="dmm"> </span>
                    </dtitle>
                    <hr>
                    <table class="table table-bordered table-condensed chgtable">
                        <thead>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Approved:</td>
                                <td>
                                    <div class="dapprov"></div>
                                </td>
                                @permission('file.price.dashboard')
                                    <td>
                                        <div class="dapprovprice"></div>
                                    </td>
                                @endpermission
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>QC-Pending:</td>
                                <td>
                                    <div class="dqcpend"></div>
                                </td>
                                @permission('file.price.dashboard')
                                    <td>
                                        <div class="dqcpendprice"></div>
                                    </td>
                                @endpermission
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Vect.Compl.:</td>
                                <td>
                                    <div class="dcompvect"></div>
                                </td>
                                @permission('file.price.dashboard')
                                    <td>
                                        <div class="dcompvectprice"></div>
                                    </td>
                                @endpermission
                            </tr>
                            <tr>
                                <td>Digit.Compl.:</td>
                                <td>
                                    <div class="dcompdigit"></div>
                                </td>
                                @permission('file.price.dashboard')
                                    <td>
                                        <div class="dcompdigitprice"></div>
                                    </td>
                                @endpermission
                            </tr>
                            ...
                            <tr>
                                <td>Tot. Completed:</td>
                                <td>
                                    <div class="dcompl"></div>
                                </td>
                                @permission('file.price.dashboard')
                                    <td>
                                        <div class="dcomplprice"></div>
                                    </td>
                                @endpermission
                            </tr>
                ...
                <div class="col-sm-3 col-lg-3">
                    ...
                    <div class="dash-unit">
                        ...
                        <table class="table table-condensed " id="clienttab">
                            <thead>
                                <tr>
                                    <th colspan="2" style="text-align: center"> {{ $curr_month }} &nbsp;Top 10 Companies
                                        Revenue </th>
                ...
                <div class="col-sm-3 col-lg-3">
                    <div class="dash-unit">
                        ...
                        <table class="table table-condensed">
                            <thead>
                                <tr>
                                    <th colspan="2" style="text-align: center">{{ $curr_month }} &nbsp; Top 10 Designer
                                        Revenue</th>
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="2"> <span style="color: blue;">Updated on {{ $curr_date }}</span>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
            ...
            <div class="col-sm-3 col-lg-3">
                ...
                <div class="dash-unit">
                    ...
                    <table class="table table-condensed" id="clienttab">
                        <thead>
                            <tr>
                                <th colspan="2" style="text-align: center"> {{ $prv_month }} &nbsp;Top 10 Companies Revenue
                                </th>
            ...
            <div class="col-sm-3 col-lg-3">
                <div class="dash-unit">
                    ...
                    <table class="table table-condensed" id="clienttab">
                        <thead>
                            <tr>
                                <th colspan="2" style="text-align: center"> {{ $prv_month }} &nbsp;Top 10 Companies File
                                    Count </th>
            ...
            <div class="col-sm-3 col-lg-3">
                <div class="dash-unit">
                    <table class="table table-condensed">
                        <thead>
                            <tr>
                                <th colspan="2" style="text-align: center">{{ $prv_month }} &nbsp; Top 10 Designer Revenue
                                </th>
            ...
            <div class="col-sm-3 col-lg-3">
                <div class="dash-unit">
                    ...
                    <table class="table table-condensed">
                        <thead>
                            <tr>
                                <th colspan="2" style="text-align: center">{{ $prv_month }} &nbsp; Top 10 Designer Count
                                </th>
...
@section('script')
    <script type="text/javascript">
        ...
        setTimeout(pendingorderFun, 3600000);
        ...
        setTimeout(dailytotaltodayFun, 9000);
        ...
        function dailytotalFun() {
            ...
            @else
                ...
                var appr_ind_vect = obj[11]["appr_ind_vect"];
                //var dcompdigitprice = obj[11]["dtotvectprice"];
                var dphoto = obj[12]["dtotphoto"];
                var dphotoprice = obj[12]["dtotphotoprice"];
