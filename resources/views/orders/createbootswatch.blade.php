...
<div class="row">
  <div class="col-md-8">
      <h3 style="">Add Order</h3>
  </div>
  <div class="col-md-4">
      <a href="{{route('orders.index')}}" class="btn btn-primary btn-outline mt-3 rightdiv">Back</a>
  </div>
</div>
...
<div class="row"  id="morefiles">
                 ...
                 <div class="modal-body">
                  <div class="row">
                    <div class="col-md-8"><b>Select Designer</b></div>
                     <div class="col-md-4"><a class="btn btn-danger btn-sm rightdiv closealloacation" id="" style="color: white;">X</a>
                     </div>
                  </div>
  ...
  <div class="col-md-1">
   ...
   <div style="text-align: center;"><input class="form-control btn btn-danger btn-outline delete" type="submit" value="Delete"><span class="countre" style="color: white; background-color: #87B0D1; border-radius: 20px;padding: 5px 6px 5px 6px;"><b>1</b></span></div>
 </div>
</div>
...
$(document).on("keyup", "input#search.form-control.searchinput", function(e){
  ...
  // added above code on 27/09/17
      ...
      // $("#clienthelp  tr").click(function(){
        ...
        var vprimary_email=$(this).find('td:eq(3)').text();
        // var vsecondary_email=$(this).find('td:eq(4)').html();
        var vcompany=$(this).find('td:eq(4)').text();
         ...
         // alert('hi');
          ...
          if(vblack_list == 'Y') {
                ...
                Swal.fire({
                          ...
                          text: 'Please contact your Administrator to proceed with the Order as the Client or Company is blacklisted'
                                                    
                      })
                   @role('csr.manager', true)  
