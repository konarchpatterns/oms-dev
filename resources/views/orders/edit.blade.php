...
<div class="row">
  <div class="col-md-8">
      <h3 style="" >Update Order : {{$Order->order_id}}  </h3>
...
<div class ="col-md-1 backbtnvisible" style="float: left;" > 
 ...
 <div class="card temcolor1">
    <div class="card-body">
{!! Form::model($Order,['method' => 'PATCH', 'id'=> 'editorderform' , 'route'=>['orders.update','id' => $Order->id]]) !!}
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
             ...
             <div class="col-md-4">
                 <a class="btn btn-danger btn-sm rightdiv closealloacation" id="" style="color: white;">X</a>
