      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-1">
                <a class="p-1 btn" href="{{route('branchuser.profile')}}">
                    {{__('Profile')}}&nbsp;<i class="fa fa-user"></i>
                </a>
            </li>
            <li class="nav-item mr-1">
                <a class="p-1 btn" href="{{route('get.password')}}">
            ...
            <li class="nav-item">
                ...
                <form id="logout-form" action="{{ route('branch_auth.logout') }}" method="POST" style="display: none;">
                    {{ csrf_field() }}
                </form>
            </li>
        </ul>
