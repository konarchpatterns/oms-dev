...
$device_link= $device_edit = $device_list =$device_index =  $device_menu = "";
...
//  device controller
if($controller == 'DeviceManagementController' && ($action == 'index' ||  $action == 'edit' )){
    $device_link = "active";$device_menu = "menu-open";
    if($action == 'index'){
      $device_index = "active";
    }
    if($action == 'edit'){
...
// device controller added on  10-07-20
    ...
    <div class="sidebar">
        ...
        <?php /*
          ...
          <ul class="sidebar-menu tree" data-widget="tree">
            ...
            <!-- added above code for device management on 10-07-20 -->
             <li class="treeview {{$printer_menu}} {{$printer_link}}">
                <a href="javascript:void(0)">
                  <i class="fa fa-print"></i>
                  <span>{{__('Device Management')}}</span>
                  <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                  </span>
                </a>
                <ul class="treeview-menu">
                   <li class="nav-item {{$device_index}}">
                      <a href="{{route('devices.index')}}" class="">
                          <i class="fa fa-circle-o nav-icon"></i>{{__('List')}}
                      </a>
                    </li>
