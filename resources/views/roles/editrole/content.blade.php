...
<form action="{{ route('role.update') }}" method="post">
    ...
    <div class="">
        <div class="row">
            <div class="col-md-9">
                <h5>
                    <a href="{{ route('role.index') }}" style="color: black;">
                        <b>Roles</b>
                    </a>
            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" class="form-control mt-0" name="name" value="{{ $role->name }}"
                                        required />
                                    <input type="hidden" name="id" value="{{ $role->id }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Slug</label>
                                    <input type="text" class="form-control mt-0" name="slug" value="{{ $role->slug }}"
                                        required />
                                </div>
                            </div>
                            <div class="col-md-1">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" value="{{ $role->description }}" required>
                                      {{ $role->description }}
                                    </textarea>
                                </div>
                            </div>
                        ...
                        <hr class="temcolor1">
                        <h5 class="font-weight-bold text-center">Permission</h5>
                                        ...
                                        @foreach ($permissions as $permission)
                                            @if (in_array($permission->description, ['List of ROLES']))
                                                ...
                                                @elseif(Auth::user()->levelRolepermission($permission->id, $role->level))
                                                    <td> <i class="fa fa-check-square ml-1" aria-hidden="true"
                                    ...
                                    <tr>
                                        ...
                                        @foreach ($permissions as $permission)
                                            @if (in_array($permission->description, ['order-view']))
                                                ...
                                                @elseif(Auth::user()->levelRolepermission($permission->id, $role->level))
                                                    <td> <i class="fa fa-check-square" aria-hidden="true"
                                                            style="color: green;"></i></td>
                                                @else
                                                    <td>
                                                        <div class="form-check">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <table id="roles" class="" style="width:100%">
                                    ...
                                    @foreach ($permissions as $permission)
                                        @if (in_array($permission->slug, ['report.revision.list', 'report.designers.revenue', 'confirm.orders.date.range', 'active.clients.date.range', 'inactive.clients.date.range', 'clients.generated.date.range']))
                                            @if ($row == 1)
                                                <?php $row = 0; ?>
                                                </tr>
                                                <tr>
