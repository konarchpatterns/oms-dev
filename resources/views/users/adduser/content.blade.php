<form action="{{ route('user.store') }}" method="post">
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-9">
                <h5><a href="{{ route('user.index') }}" style="color: black;"><b>User</b></a> <i
                        class="fa fa-angle-double-right "></i>Create</h5>
            </div>
            <div class="col-md-3">
                                    ...
                                    <td>
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input class="form-check-input1" type="checkbox" name="assignroles[]"
                                                    value="{{ $role->id }}">
