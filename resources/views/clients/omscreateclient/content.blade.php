 ...
 <div class="row">
            <div class="col-md-12" id="headingTwo">
                <nav class="nav nav-tabs bg-info">
                  <a href="JavaScript:void(0);" class="nav-item nav-link text-white active"  id="collapseOne23" ><b>Company Information</b></a>
                  <a href="JavaScript:void(0);" class="nav-item nav-link text-white collapseclient"><b>Client Information</b></a>
                </nav>
...
<div id="collapseOne">
  <div class="row"> 
    ...
    <div class="col-md-3 px-1"> 
       ...
       <a href="JavaScript:void(0);" id="addcompanyemail" class="btn btn-outline btn-sm btn-primary mt-1"><i class="fa fa-plus" aria-hidden="true"></i></a>
    </div>  
    ...
    <div class="col-md-3 pl-1"> 
        ...
        <a href="#" id="addcompanyphone" class="btn btn-sm btn-outline btn-primary mt-1"> <i class="fa fa-plus" aria-hidden="true"></i> </a>
    </div>  
 ...
 <div id="collapseTwo">
  ...
  <div class="row">
    ...
    <div class="col-md-4 mt-3">
        <button type="submit" class="btn btn-warning  chkerror rightdiv" name="submitbutton" value="formsubmit">Submit</button>
