...
<input type="hidden" name="client_company" value="{{$clientdtl->client_company}}">
    ...
    @endphp
        ...
        @endforeach
            ...
            <a href="JavaScript:void(0);" class="btn btn-sm btn-primary btn-outline addclientemail"> <i class="fa fa-plus" aria-hidden="true"></i></a>
        ...
        @endforeach
             ...
             <a href="JavaScript:void(0);" class="btn btn-sm btn-primary btn-outline addclientphone"> <i class="fa fa-plus" aria-hidden="true"></i></a>
