...
<input type="hidden" name="company_id" value="{{$client->company_id}}">
 <div class="row">
    ...
    <div class="col-md-9 mt-3">
        <a href="{{route('clients.show',['id'=>$client->id])}}" class="btn btn-danger btn-outline rightdiv ml-2">Cancel</a>
        <button class="btn btn-outline btn-primary rightdiv chkerror">Update</button>
...
<div id="collapseOne">
  <div class="row"> 
    <div class="col-md-3 pr-1"> 
      <div class="form-group">
        <label>Company Name<span style='color: red'>*</span></label>
         <input type="text" name="client_company" class="form-control compinput" autofocus="" required="" id="client_company" value="{{$client->client_company}}">
    ...
    @endforeach
       ...
       <a href="JavaScript:void(0);" id="addcompanyemail" class="btn btn-outline btn-sm btn-primary"><i class="fa fa-plus" aria-hidden="true"></i></a>
    ...
    <div class="col-md-3 pl-1"> 
      ...
      @endforeach
        ...
        <a href="#" id="addcompanyphone" class="btn btn-sm btn-outline btn-primary "> <i class="fa fa-plus" aria-hidden="true"></i> </a>
