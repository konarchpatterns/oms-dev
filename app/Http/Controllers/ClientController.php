        ...
        try {
            ...
            $userid = Auth::id();
                ...
                $red_list_details = (string)$request->input('red_list_details');
                 if($red_list == 'N'){
                    $red_list_details = '';
                     DB::table('client_dtls')->where('client_id', $cid)->update(['black_list'=>'N']);
                }
                if($red_list == 'Y'){
                 
                     DB::table('client_dtls')->where('client_id', $cid)->update(['black_list'=>'Y']);  
                }
                $store_type=implode(",",$request->input('store_type'));
 ...
 public function getphone(Request $request ) {
  ...
  public function updateclient(Request $request){
      ...
      //phone duplication validation
        ...
        //remove below duplication of contact no code
