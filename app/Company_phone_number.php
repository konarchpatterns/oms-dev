...
class Company_phone_number extends Model
{
	 use LogsActivity;
   protected static $logName = 'Company Phone';
     protected $table = 'company_phone_numbers';
     protected $fillable = [
        'company_id','company_phone','phone_type','dammy','deleted',
    ];
    ...
    {
    	 $companyids=DB::table('company_phone_numbers')->where('id', $activity->subject_id)->get();
