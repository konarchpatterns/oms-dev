...
class CreateCompanyPhoneCompanyMasterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('company_phone_company_master', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('company_phone_company_master');
    }
}
